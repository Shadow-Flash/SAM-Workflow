...
```bash
cbl-workflow$ sam logs -n StockCheckerFunction --stack-name cbl-workflow --tail
```
...
```bash
cbl-workflow$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name cbl-workflow
```
